                                            ...
                                            <div class="card-body d-block text-left p-0">
                                                <div class="item w-100 h150 bg-white rounded-xxl overflow-hidden text-left shadow-md ps-3 pt-2 align-items-end flex-column d-flex">
                                                    <div class="card border-0 shadow-none p-0 bg-transparent-card text-left w-100">
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <img src="images/b-9.png" alt="icon" class="w40 float-left d-inline-block">
                                                            </div>
                                                            <div class="col-6 text-right pe-4">
                                                                <img src="images/chip.png" alt="icon" class="w30 float-right d-inline-block mt-2 me-2">
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card-bod6 d-block text-left 2 fw-600-0">
                                                <div class="item w-100 h150 bg-gold-gradiant rounded-xxl overflow-hidden text-left shadow-md ps-3 pt-2 align-items-end flex-column d-flex">
                                                    <div class="card bg-transparent border-0 bg-transparent-card shadow-none p-0 text-left w-100">
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <img src="images/b-14.png" alt="icon" class="w90 float-left d-inline-block">
                                                            </div>
                                                            <div class="col-6 text-right pe-4">
                                                                <img src="images/chip.png" alt="icon" class="w30 float-right d-inline-block mt-2 me-2 rounded-xxl">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card bg-transparent border-0 bg-transparent-card shadow-none p-0 text-left w-100">
                                                        <div class="row">
                                                            <div class="col-6">
                                                                ...
                                                                <img src="images/b-10.png" alt="icon" class="w40 float-left d-inline-block">
                                                            </div>
                                                            <div class="col-6 text-right pe-4">
                                                                <img src="images/chip.png" alt="icon" class="w30 float-right d-inline-block mt-2 me-2 rounded-3">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card bg-transparent border-0 bg-transparent-card shadow-none p-0 text-left w-100 mt-auto">
                                                    ...
                                                    <div class="card border-0 bg-transparent-card shadow-none p-0 text-left w-100">
                                                        <div class="row">
                                                            <div class="col-6 ps-2">
                                                                <img src="images/b-17.png" alt="icon" class="w60 float-left d-inline-block">
                                                            </div>
                                                            <div class="col-6 text-right pe-4">
                                                                <img src="images/chip.png" alt="icon" class="w30 float-right d-inline-block mt-2 me-2">
                                                            </div>
                                                ...
                                                <form>
                                                    <div class="form-group mb-1">
                                                        ...
                                                        <div class="form-group icon-tab">
                                                            <input type="text" class="bg-white font-xsss border-0 rounded-3 form-control ps-4 bg-color-none border-bottom text-grey-900" placeholder="1234 1234 1234 1234">                        
                                                        </div>
                                                    </div>
                                                    <div class="form-group mb-1">
                                                        <label class="text-dark-color text-grey-600 font-xssss mb-2 fw-600" for="exampleInputPassword1">Card Holder Name</label>
                                                        <div class="form-group icon-tab">
                                                            <input type="text" class="bg-white border-0 rounded-3 form-control ps-4 bg-color-none border-bottom text-grey-900" placeholder="Name">                        
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group mb-1">
                                                                ...
                                                                <div class="form-group icon-tab">
                                                                    <input type="text" class="bg-white border-0 rounded-3 form-control ps-4 bg-color-none border-bottom text-grey-900" placeholder="03">                        
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-group mb-1">
                                                                ...
                                                                <div class="form-group icon-tab">
                                                                    <input type="text" class="bg-white border-0 rounded-3 form-control ps-4 bg-color-none border-bottom text-grey-900" placeholder="2021">                        
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <a href="#" class="rounded-3 bg-current mb-2 mt-4 p-3 w-100 fw-600 fw-700 text-center font-xssss mont-font text-uppercase ls-3 text-white d-block">Add Card</a>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>       
