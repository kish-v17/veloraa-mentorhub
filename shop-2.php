...
<body class="color-theme-blue mont-font">
    ...
    <div class="main-wrapper"> -->
        ...
        <!-- <div class="nav-header bg-white shadow-xs border-0">
            ...
            <a href="default.php" class="p-2 text-center ms-3 menu-icon center-menu-icon"><i class="feather-home font-lg bg-greylight btn-round-lg theme-dark-bg text-grey-500 "></i></a>
            ...
            <a href="shop-2.php" class="p-2 text-center ms-0 menu-icon center-menu-icon"><i class="feather-shopping-bag font-lg alert-primary btn-round-lg theme-dark-bg text-current "></i></a>
                        ...
                        <div class="col-xl-12">
                            <div class="row">
                                        ...
                                        <div class="banner-slider owl-carousel owl-theme dot-style2 owl-nav-link link-style3 overflow-hidden">
                                             <div class="owl-items style1 d-flex align-items-center bg-lightblue" >
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6"><img src="images/pl-22.png" alt="image" class="img-fluid p-md-5 p-4"></div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card w-100 border-0 mt-4">
                                        <div class="card-image w-100 p-0 text-center bg-greylight rounded-3 mb-2">
                                            <a href="single-product.php"><img src="images/pp-9.png" alt="product-image" class="w-100 mt-0 mb-0 p-5"></a>
                                        </div>
                                        <div class="card-body w-100 p-0 text-center">
                                            ...
                                            <h2 class="mt-1 mb-1"><a href="single-product.php" class="text-black fw-700 font-xsss lh-26">Textured Sleeveless Camisole</a></h2>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card w-100 border-0 mt-4">
                                        <div class="card-image w-100 p-0 text-center bg-greylight rounded-3 mb-2">
                                            <a href="single-product.php"><img src="images/pp-10.png" alt="product-image" class="w-100 mt-0 mb-0 p-5"></a>
                                        </div>
                                        <div class="card-body w-100 p-0 text-center">
                                            <div class="star w-100 d-block text-left mt-0 text-center">
                                                <img src="images/star.png" alt="star" class="w15">
                                            ...
                                            <h2 class="mt-1 mb-1"><a href="single-product.php" class="text-black fw-700 font-xsss lh-26">Adjustable Shoulder Straps</a></h2>
                                            <h6 class="font-xsss fw-600 text-grey-500 ls-2">$449</h6>
                                        </div>                                
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card w-100 border-0 mt-4">
                                        <div class="card-image w-100 p-0 text-center bg-greylight rounded-3 mb-2">
                                            <a href="single-product.php"><img src="images/pp-13.png" alt="product-image" class="w-100 mt-0 mb-0 p-5"></a>
                                        </div>
                                        <div class="card-body w-100 p-0 text-center">
                                            <div class="star w-100 d-block text-left mt-0 text-center">
                                                <img src="images/star.png" alt="star" class="w15">
                                            ...
                                            <h2 class="mt-1 mb-1"><a href="single-product.php" class="text-black fw-700 font-xsss lh-26">Neck Strappy Camisole</a></h2>
                                            <h6 class="font-xsss fw-600 text-grey-500 ls-2">$449</h6>
                                        </div>                                
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card w-100 border-0 mt-4">
                                        <div class="card-image w-100 p-0 text-center bg-greylight rounded-3 mb-2">
                                            <a href="single-product.php"><img src="images/pp-14.png" alt="product-image" class="w-100 mt-0 mb-0 p-5"></a>
                                        </div>
                                        <div class="card-body w-100 p-0 text-center">
                                            <div class="star w-100 d-block text-left mt-0 text-center">
                                                <img src="images/star.png" alt="star" class="w15">
                                            ...
                                            <h2 class="mt-1 mb-1"><a href="single-product.php" class="text-black fw-700 font-xsss lh-26">Scoop-Neck Strappy</a></h2>
                                            <h6 class="font-xsss fw-600 text-grey-500 ls-2">$449</h6>
                                        </div>                                
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <div class="card w-100 border-0 mt-4">
                                        <div class="card-image w-100 p-0 text-center bg-greylight rounded-3 mb-2">
                                            <a href="single-product.php"><img src="images/pp-8.png" alt="product-image" class="w-100 mt-0 mb-0 p-5"></a>
                                        </div>
                                        <div class="card-body w-100 p-0 text-center">
                                            <div class="star w-100 d-block text-left mt-0 text-center">
                                                <img src="images/star.png" alt="star" class="w15">
                                            ...
                                            <h2 class="mt-1 mb-1"><a href="single-product.php" class="text-black fw-700 font-xsss lh-26">Butler Stool Ladder</a></h2>
                                            <h6 class="font-xsss fw-600 text-grey-500 ls-2">$449</h6>
                                        </div>                                
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card w-100 border-0 mt-4">
                                        <div class="card-image w-100 p-0 text-center bg-greylight rounded-3 mb-2">
                                            <a href="single-product.php"><img src="images/pp-22.png" alt="product-image" class="w-100 mt-0 mb-0 p-5"></a>
                                        </div>
                                        <div class="card-body w-100 p-0 text-center">
                                            <div class="star w-100 d-block text-left mt-0 text-center">
                                                <img src="images/star.png" alt="star" class="w15">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card w-100 border-0 mt-4">
                                        <div class="card-image w-100 p-0 text-center bg-greylight rounded-3 mb-2">
                                            <a href="single-product.php"><img src="images/pp-23.png" alt="product-image" class="w-100 mt-0 mb-0 p-5"></a>
                                        </div>
                                        <div class="card-body w-100 p-0 text-center">
                                            <div class="star w-100 d-block text-left mt-0 text-center">
                                                <img src="images/star.png" alt="star" class="w15">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card w-100 border-0 mt-4">
                                        <div class="card-image w-100 p-0 text-center bg-greylight rounded-3 mb-2">
                                            <a href="single-product.php"><img src="images/pp-11.png" alt="product-image" class="w-100 mt-0 mb-0 p-5"></a>
                                        </div>
                                        <div class="card-body w-100 p-0 text-center">
                                            <div class="star w-100 d-block text-left mt-0 text-center">
                                                <img src="images/star.png" alt="star" class="w15">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="card w-100 border-0 mt-4">
                                        <div class="card-image w-100 p-0 text-center bg-greylight rounded-3 mb-2">
                                            <a href="single-product.php"><img src="images/pp-4.png" alt="product-image" class="w-100 mt-0 mb-0 p-5 mt-4 mb-4"></a>
                                        </div>
                                        <div class="card-body w-100 p-0 text-center">
                                            <div class="star w-100 d-block text-left mt-0 text-center">
                                                <img src="images/star.png" alt="star" class="w15">
