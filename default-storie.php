...
<body class="color-theme-blue mont-font">
    ...
    <div class="main-wrapper"> -->
        ...
        <!-- <div class="nav-header bg-white shadow-xs border-0">
            ...
            <a href="default-storie.php" class="p-2 text-center ms-0 menu-icon center-menu-icon"><i class="feather-zap font-lg alert-primary btn-round-lg theme-dark-bg text-primary "></i></a>
                            ...
                            <div class="row ps-2 pe-1">
                                 <div class="col-md-3 col-xss-6 pe-2 ps-2">
                                     <div class="card h300 d-block border-0 shadow-xss rounded-3 bg-gradiant-bottom overflow-hidden mb-3 bg-image-cover" style="background-image: url(images/s-1.jpg);">
                                        <div class="card-body d-block w-100 position-absolute bottom-0 text-center">
                                            <figure class="avatar ms-auto me-auto mb-0 position-relative w50 z-index-1"><img src="images/user-7.png" alt="image" class="float-right p-0 bg-white rounded-circle w-100 shadow-xss"></figure>
                                 ...
                                 <div class="col-md-3 col-xss-6 pe-2 ps-2">
                                     <div class="card h300 d-block border-0 shadow-xss rounded-3 bg-gradiant-bottom overflow-hidden mb-3 bg-image-cover" style="background-image: url(images/s-6.jpg);">
                                        <div class="card-body d-block w-100 position-absolute bottom-0 text-center">
                                            <figure class="avatar ms-auto me-auto mb-0 position-relative w50 z-index-1"><img src="images/user-8.png" alt="image" class="float-right p-0 bg-white rounded-circle w-100 shadow-xss"></figure>
                                            <div class="clearfix"></div>
                                            <h4 class="fw-600 position-relative z-index-1 ls-3 font-xssss text-white mt-2 mb-1">Surfiya Zakir</h4>
                                        </div>
                                    </div>
