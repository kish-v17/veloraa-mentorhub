                    ...
                    <div class="row">
                        <div class="col-xl-12 col-xxl-12 col-lg-12">
                            <div class="product-slider owl-nav-link owl-carousel owl-theme">
                                <div class="owl-items"><img src="images/p-1.jpg" alt="product-image" class="rounded-3"></div>
                                <div class="owl-items"><img src="images/p-2.jpg" alt="product-image" class="rounded-3"></div>
                                <div class="owl-items"><img src="images/p-3.jpg" alt="product-image" class="rounded-3"></div>
                            </div>
                        </div>               
                    </div>
                    <div class="row">
                        <div class="col-xl-8 col-xxl-9 col-lg-8">
                            <div class="card d-block mt-4 border-0 shadow-xss bg-white p-lg-5 p-4">
                                <span class="font-xsssss fw-700 ps-3 pe-3 lh-32 text-uppercase rounded-3 ls-2 bg-primary-gradiant d-inline-block text-white ">Featured</span>
                                <h2 class="fw-700 font-lg mt-3 mb-2">House Party Graynight Mood In Siver Colony, London</h2>
                                <p class="font-xsss fw-500 text-grey-500 lh-30 pe-5 mt-3 me-5">ultrices justo eget, sodales orci. Aliquam egestas libero ac turpis pharetra, in vehicula lacus scelerisque. Vestibulum ut sem laoreet, feugiat tellus at, hendrerit arcu.</p>
                            ...
                            <div class="card d-block border-0 rounded-3 overflow-hidden p-4 shadow-xss mt-4">
                                ...
                                <p class="font-xssss fw-500 lh-28 text-grey-600 mb-0 ps-2">After creating more than a dozen courses on Microsoft Access databases and programming in VBA, many students have contacted me with discussions on specific problems and scenarios.  From these discussions, I have created videos reviewing the details of the most useful techniques that everyone will eventually need.  I have made sure that every detail of these techniques is recorded in the videos!  BUT you should be somewhat familiar with VBA since there are lots of coding examples in the course. <br>                                        There are MANY tips and tricks in this workshop that you will not find an ANY of my other courses! <br>  I also include a specific database design challenge from a student and then go over the details of how I would handle it. <br> If you are willing to take the time to go through this course you could easily be much more productive with Microsoft Access in just a few hours! </p>
                            </div>
                        ...
                        <div class="col-xl-4 col-xxl-3 col-lg-4 ps-0">
                            <div class="card w-100 border-0 mt-4 mb-4 p-lg-4 p-3 shadow-xss position-relative rounded-3 bg-white">
                                <div class="section full mb-4 p-4 bg-light theme-dark-bg theme-light-bg rounded-3">
                                    <div class="row">
                                        <div class="col-12 text-center">
                                            <h2 class="display2-size lh-1 m-0 text-grey-900 fw-700">4.3</h2>
                                        </div>
                                        <div class="col-12 text-center">
                                            <h4 class="font-xssss text-grey-600 fw-600 mt-2">Based on 433 rating</h4>
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-5 ps-1 text-right"><h4 class="font-xssss mt-1 fw-700 text-grey-800">Support</h4></div>
                                    </div>
                                    <div class="row mt-1">
                                        <div class="col-7 pe-1 mt-0">
                                            <div class="star d-inline text-left">
                                        ...
                                        <div class="col-5 ps-1 text-right"><h4 class="font-xssss mt-1 fw-700 text-grey-800">Clean</h4></div>
                                    </div>
                                    <div class="row mt-1">
                                        <div class="col-7 pe-1 mt-0">
                                            <div class="star d-inline text-left">
                                        ...
                                        <div class="col-5 ps-1 text-right"><h4 class="font-xssss mt-1 fw-700 text-grey-800">Speed</h4></div>
                                    </div>
                                    <div class="row mt-1">
                                        <div class="col-7 pe-1 mt-0">
                                            <div class="star d-inline text-left">
                                        ...
                                        <div class="col-5 ps-1 text-right"><h4 class="font-xssss mt-1 fw-700 text-grey-800">Quality</h4></div>
                                    </div>
                                    <div class="row mt-1">
                                        <div class="col-7 pe-1 mt-0">
                                            <div class="star d-inline text-left">
                                        ...
                                        <div class="col-5 ps-1 text-right"><h4 class="font-xssss mt-1 fw-700 text-grey-800">Delivery</h4></div>
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-2 text-left">
                                        <figure class="avatar float-left mb-0"><img src="images/user-7.png" alt="image" class="float-right shadow-none w40 me-2"></figure>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-2 text-left">
                                        <figure class="avatar float-left mb-0"><img src="images/user-6.png" alt="image" class="float-right shadow-none w40 me-2"></figure>
                                    </div>
                                    <div class="col-10 ps-4">
                                        <div class="content">
                                            <h6 class="author-name font-xssss fw-600 mb-0 text-grey-800">Goria Coast</h6>
                                ...
                                <div class="row">
                                    <div class="col-2 text-left">
                                        <figure class="avatar float-left mb-0"><img src="images/user-5.png" alt="image" class="float-right shadow-none w40 me-2"></figure>
                                    </div>
                                    <div class="col-10 ps-4">
                                        <div class="content">
                                            <h6 class="author-name font-xssss fw-600 mb-0 text-grey-800">Goria Coast</h6>
                                ...
                                <div class="row">
                                    <div class="col-2 text-left">
                                        <figure class="avatar float-left mb-0"><img src="images/user-3.png" alt="image" class="float-right shadow-none w40 me-2"></figure>
                                    </div>
                                    <div class="col-10 ps-4">
                                        <div class="content">
                                            <h6 class="author-name font-xssss fw-600 mb-0 text-grey-800">Goria Coast</h6>
                                ...
                                <div class="row"><a href="#" class="d-block p-2 lh-32 text-center bg-greylight fw-600 font-xssss text-grey-900 rounded-3">Add a Review</a></div>
                            </div>
                                ...
                                <form action="#">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <a href="#" class="bg-primary-gradiant border-0 text-white fw-600 text-uppercase font-xssss float-left rounded-3 d-block mt-0 w-100 p-2 lh-34 text-center ls-3 ">Contact US</a>
                                        </div>
                                    </div>
