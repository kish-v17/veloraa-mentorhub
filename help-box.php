            ...
            <div class="middle-sidebar-bottom">
                <div class="middle-sidebar-left">
                    <div class="row justify-content-center">
                        <div class="col-xl-10">
                            <div class="card w-100 border-0 p-0 rounded-3 overflow-hidden bg-image-contain bg-image-center" style="background-image: url(images/help-bg.png);">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group icon-input mb-0">
                                                    ...
                                                    <input type="text" class="style1-input border-0 ps-5 font-xsss mb-0 text-grey-500 fw-500 bg-transparent" placeholder="Search anythings..">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
